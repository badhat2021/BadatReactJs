...
export const SimpleDialog = (props) => {
  ...
  return (
    <Dialog onClose={handleClose} aria-labelledby="simple-dialog-title" open={open} fullWidth maxWidth="sm" scroll="paper">
      ...
      <List>
          <ListItem button>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Order Number </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography>#{props.data.id}</Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <ListItem button>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Total Item </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography>{props.itemsCount}</Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <ListItem button onClick={handleClose}>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Order Amount </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography>{props.totPrice}</Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <ListItem button>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Date </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography>{props.date}</Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <ListItem button style={{marginBottom: 10}}>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Status </Typography></ListItemText>
            <ListItemSecondaryAction>
          ...
          <Divider style={{height: 3}}/>
          <ListItem button>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Buyer </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography>
              {orderDetails? `${orderDetails.user.name} | ${orderDetails.user.business_name}`:""}
              </Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <ListItem button>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Seller </Typography></ListItemText>
            <ListItemSecondaryAction>
            { 
              orderDetails ?
                <Typography>{orderDetails.items[0].product.user.name} | {orderDetails.items[0].product.user.business_name}</Typography>
              : 
                ""
            }
            </ListItemSecondaryAction>
          ...
          <ListItem button style={{marginBottom: 10, height: 95}}>
            <ListItemText><Typography style={{fontWeight: "bold"}}> Buyer Address </Typography></ListItemText>
            <ListItemSecondaryAction>
              <Typography> {orderDetails ? `${orderDetails.user.address}\n${orderDetails.user.city} , ${orderDetails.user.district}\n${orderDetails.user.state} , ${orderDetails.user.pincode}`: ''}</Typography>
            </ListItemSecondaryAction>
          </ListItem>
          <Divider style={{height:3}}/>
          {orderDetails ? 
             orderDetails.items.map((item) => (<ItemList item={item} key={item.id}/>)) : <CircularProgress /> }
...
const ItemList = (props) => {
  ...
  return(
              <ListItem button onClick={() => {productPage(props.item.product.id)}}>                
                <ListItemText><Typography style={{fontWeight: "bold"}}> {props.item.product?`${props.item.product.name} - Rs ${props.item.price} per quantity`:"Item not found"} </Typography></ListItemText>
                <ListItemSecondaryAction>
